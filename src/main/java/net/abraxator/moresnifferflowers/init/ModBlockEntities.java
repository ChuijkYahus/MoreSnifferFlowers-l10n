...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ModCauldronBlockEntity>> MOD_CAULDRON = BLOCK_ENTITIES.register("mod_cauldron", () -> BlockEntityType.Builder.of(ModCauldronBlockEntity::new, ModBlocks.ACID_FILLED_CAULDRON.get(), ModBlocks.BONMEEL_FILLED_CAULDRON.get()).build(null));

...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<SaltemoneBlockEntity>> SALTEMONE = BLOCK_ENTITIES.register("saltemone", () -> BlockEntityType.Builder.of(SaltemoneBlockEntity::new, ModBlocks.SALTEMONE.get(), ModBlocks.SOURLEMONE.get()).build(null));
    public static final RegistryObject<BlockEntityType<TorchflowerBlockEntity>> TORCHFLOWER = BLOCK_ENTITIES.register("torchflower", () -> BlockEntityType.Builder.of(TorchflowerBlockEntity::new, ModBlocks.TORCHFLOWER_AFLAME.get()).build(null));

    public static final RegistryObject<BlockEntityType<ModCauldronBlockEntity>> MOD_CAULDRON = BLOCK_ENTITIES.register("mod_cauldron", () -> BlockEntityType.Builder.of(ModCauldronBlockEntity::new, ModBlocks.ACID_FILLED_CAULDRON.get(), ModBlocks.BONMEEL_FILLED_CAULDRON.get()).build(null));

...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<BoblingEntity>> BOBLING = buildNoEgg(MoreSnifferFlowers.loc("bobling"), makeBuilder(BoblingEntity::new, MobCategory.CREATURE, 2.375F, 2.8125F, 80, 3), false);

...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<SaltBubbleProjectile>> SALT_BUBBLE = buildNoEgg(MoreSnifferFlowers.loc("salt_bubble"), makeBuilder(SaltBubbleProjectile::new, MobCategory.MISC, 0.4F, 0.4F, 80, 3), false);

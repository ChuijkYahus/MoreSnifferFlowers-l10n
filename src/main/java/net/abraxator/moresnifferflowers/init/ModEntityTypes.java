...
public class ModEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ModBoatEntity>> CORRUPTED_BOAT = buildNoEgg(MoreSnifferFlowers.loc("corrupted_boat"), makeBuilder(boatFactory(ModItems.CORRUPTED_BOAT), MobCategory.MISC, 1.375f, 0.5625f, 80, 3), false);
    public static final DeferredHolder<EntityType<?>, EntityType<ModChestBoatEntity>> CORRUPTED_CHEST_BOAT = buildNoEgg(MoreSnifferFlowers.loc("corrupted_chest_boat"), makeBuilder(chestBoatFactory(ModItems.CORRUPTED_CHEST_BOAT), MobCategory.MISC, 1.375f, 0.5625f, 80, 3), false);
    public static final DeferredHolder<EntityType<?>, EntityType<VivicusBoatEntity>> VIVICUS_BOAT = buildNoEgg(MoreSnifferFlowers.loc("vivicus_boat"), makeBuilder(vivicusBoatFactory(ModItems.VIVICUS_BOAT), MobCategory.MISC, 1.375f, 0.5625f, 80, 3), false);
    public static final DeferredHolder<EntityType<?>, EntityType<VivicusChestBoatEntity>> VIVICUS_CHEST_BOAT = buildNoEgg(MoreSnifferFlowers.loc("vivicus_chest_boat"), makeBuilder(vivicusChestBoatFactory(ModItems.VIVICUS_CHEST_BOAT), MobCategory.MISC, 1.375f, 0.5625f, 80, 3), false);

...
public class ModEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SaltBubbleProjectile>> SALT_BUBBLE = buildNoEgg(MoreSnifferFlowers.loc("salt_bubble"), makeBuilder(SaltBubbleProjectile::new, MobCategory.MISC, 0.7F, 0.7F, 80, 3), false);
    public static final DeferredHolder<EntityType<?>, EntityType<SaltProjectile>> SALT_PROJECTILE = buildNoEgg(MoreSnifferFlowers.loc("salt_projectile"), makeBuilder(SaltProjectile::new, MobCategory.MISC, 0.25F, 0.25F, 80, 3), false);
    public static final DeferredHolder<EntityType<?>, EntityType<GluingGumEntity>> GLUING_GUM_ENTITY = buildNoEgg(MoreSnifferFlowers.loc("gluing_gum_entity"), makeBuilder(GluingGumEntity::new, MobCategory.MISC, 0.25F, 0.25F, 80, 3), false);

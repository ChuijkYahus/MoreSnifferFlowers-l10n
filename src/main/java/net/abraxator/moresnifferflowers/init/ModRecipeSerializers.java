...
public class ModRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<RebrewedTippedArrowRecipe>> REBREWED_TIPPED_ARROW = RECIPE_SERIALIZERS.register("rebrewed_tipped_arrow", () -> new CustomRecipe.Serializer<>(RebrewedTippedArrowRecipe::new));
}

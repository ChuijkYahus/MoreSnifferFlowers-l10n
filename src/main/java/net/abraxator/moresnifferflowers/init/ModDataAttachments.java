...
public class ModDataAttachments {
    ...
    public static final Supplier<AttachmentType<BlockPatternCapability>> BLOCK_PATTERNS = ATTACHMENT_TYPES.register("block_patterns", () -> AttachmentType.builder(() -> new BlockPatternCapability(new HashMap<>())).serialize(BlockPatternCapability.CODEC)
    ...
    public static final Supplier<AttachmentType<CorruptionCapability>> CHUNK_CORRUPTION = ATTACHMENT_TYPES.register("corruption", () -> AttachmentType.builder(() -> new CorruptionCapability()).serialize(CorruptionCapability.CODEC).build());
    ...
    public static final Supplier<AttachmentType<NutritionCapability>> NUTRITION = ATTACHMENT_TYPES.register("nutrition", () -> AttachmentType.builder(NutritionCapability::new).serialize(NutritionCapability.CODEC).copyOnDeath().build());

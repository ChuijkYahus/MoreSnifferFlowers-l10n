...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> AMBUSH_BOTTOM = BLOCKS.register("ambush_bottom", registryName -> new AmbushBlockLower(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> AMBUSH_TOP = BLOCKS.register("ambush_top", registryName -> new AmbushBlockUpper(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> GARBUSH_BOTTOM = BLOCKS.register("garbush_bottom", registryName -> new GarbushBlockLower(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> GARBUSH_TOP = BLOCKS.register("garbush_top", registryName -> new GarbushBlockUpper(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> BONMEELIA = registerBlockNoItem("bonmeelia", (registryName) ->  new BonmeeliaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).lightLevel(value -> 3).noOcclusion().setId(getBlockResourceKey(registryName)), false));
    public static final DeferredBlock<Block> BONWILTIA = registerBlockNoItem("bonwiltia", (registryName) ->  new BonmeeliaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).strength(0.2F).lightLevel(value -> 3).noOcclusion().setId(getBlockResourceKey(registryName)), true));

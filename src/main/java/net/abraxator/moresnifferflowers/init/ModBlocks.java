...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> AMBUSH_BOTTOM = BLOCKS.register("ambush_bottom", registryName -> new AmbushBlockLower(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> AMBUSH_TOP = BLOCKS.register("ambush_top", registryName -> new AmbushBlockUpper(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> GARBUSH_BOTTOM = BLOCKS.register("garbush_bottom", registryName -> new GarbushBlockLower(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).setId(getBlockResourceKey(registryName))));
    public static final DeferredBlock<Block> GARBUSH_TOP = BLOCKS.register("garbush_top", registryName -> new GarbushBlockUpper(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> AMBER_MOSAIC_WALL = registerBlockWithItem("amber_mosaic_wall", (registryName) -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.AMBER_MOSAIC.get()).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> CHISELED_GARNET_SLAB = registerBlockWithItem("chiseled_garnet_slab", (registryName) -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.CHISELED_GARNET.get()).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> BONMEELIA = registerBlockNoItem("bonmeelia", (registryName) ->  new BonmeeliaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).lightLevel(value -> 3).noOcclusion().setId(getBlockResourceKey(registryName)), false));
    public static final DeferredBlock<Block> BONWILTIA = registerBlockNoItem("bonwiltia", (registryName) ->  new BonmeeliaBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER_CROP).strength(0.2F).lightLevel(value -> 3).noOcclusion().setId(getBlockResourceKey(registryName)), true));
    ...
    public static final DeferredBlock<Block> CORRUPTED_WOOD = registerBlockWithItem("corrupted_wood", (registryName) -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WARPED_HYPHAE).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> CORRUPTED_FENCE = registerBlockWithItem("corrupted_fence", (registryName) -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WARPED_FENCE).setId(getBlockResourceKey(registryName))));
    ...
    public static final DeferredBlock<Block> CORRUPTED_SAPLING = registerBlockWithItem("corrupted_sapling", (registryName) -> new SaplingBlock(ModTreeGrowers.CORRUPTED_TREE, BlockBehaviour.Properties.ofFullCopy(Blocks.ACACIA_SAPLING).setId(getBlockResourceKey(registryName))));

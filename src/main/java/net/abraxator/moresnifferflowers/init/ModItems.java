...
public class ModItems {
    ...
    public static final DeferredItem<Item> DAWNBERRY_VINE_SEEDS = ITEMS.register("dawnberry_vine_seeds", () -> new BlockItem(ModBlocks.DAWNBERRY_VINE.get(), new Item.Properties().useItemDescriptionPrefix()));
    public static final DeferredItem<Item> GLOOMBERRY_VINE_SEEDS = ITEMS.register("gloomberry_vine_seeds", () -> new BlockItem(ModBlocks.GLOOMBERRY_VINE.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> AMBUSH_SEEDS = ITEMS.register("ambush_seeds", () -> new BlockItem(ModBlocks.AMBUSH_BOTTOM.get(), new Item.Properties().useItemDescriptionPrefix()));
    public static final DeferredItem<Item> GARBUSH_SEEDS = ITEMS.register("garbush_seeds", () -> new BlockItem(ModBlocks.GARBUSH_BOTTOM.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> AROMA_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("aroma_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    public static final DeferredItem<Item> CARNAGE_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("carnage_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DYESPRIA_SEEDS = ITEMS.register("dyespria_seeds", () -> new BlockItem(ModBlocks.DYESPRIA_PLANT.get(), new Item.Properties().useItemDescriptionPrefix()) {
        @Override
    ...
    public static final DeferredItem<Item> BONMEELIA_SEEDS = ITEMS.register("bonmeelia_seeds", () -> new BlockItem(ModBlocks.BONMEELIA.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> BONDRIPIA_SEEDS = ITEMS.register("bondripia_seeds", () -> new BlockItem(ModBlocks.BONDRIPIA.get(), new Item.Properties()) {
        @Override
    ...
    public static final DeferredItem<Item> BONWILTIA_SEEDS = ITEMS.register("bonwiltia_seeds", () -> new BlockItem(ModBlocks.BONWILTIA.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> ACIDRIPIA_SEEDS = ITEMS.register("acidripia_seeds", () -> new BlockItem(ModBlocks.ACIDRIPIA.get(), new Item.Properties().useItemDescriptionPrefix()));

    public static final DeferredItem<Item> CROPRESSOR = ITEMS.register("cropressor", () -> new CropressorItem(ModBlocks.CROPRESSOR_OUT.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> REBREWING_STAND = ITEMS.register("rebrewing_stand", () -> new BlockItem(ModBlocks.REBREWING_STAND_BOTTOM.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    public static final DeferredItem<Item> TATER_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("tater_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    public static final DeferredItem<Item> CAROTENE_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("carotene_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    public static final DeferredItem<Item> BEAT_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("beat_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    public static final DeferredItem<Item> NETHER_WART_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("nether_wart_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    public static final DeferredItem<Item> GRAIN_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("grain_armor_trim_smithing_template", () -> SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties()));
    ...
    public static final DeferredItem<Item> CORRUPTED_SIGN = ITEMS.register("corrupted_sign", () -> new SignItem(ModBlocks.CORRUPTED_SIGN.get(), ModBlocks.CORRUPTED_WALL_SIGN.get(), new Item.Properties()));
    ...
    public static final DeferredItem<Item> VIVICUS_SIGN = ITEMS.register("vivicus_sign", () -> new SignItem(ModBlocks.VIVICUS_SIGN.get(), ModBlocks.VIVICUS_WALL_SIGN.get(), new Item.Properties()));
    ...
    public static final DeferredItem<Item> BOBLING_SPAWN_EGG = ITEMS.register("bobling_spawn_egg", () -> new SpawnEggItem(ModEntityTypes.BOBLING.get(), new Item.Properties()));

    public static final DeferredItem<Item> CAULORFLOWER_SEEDS = ITEMS.register("caulorflower_seeds", () -> new BlockItem(ModBlocks.CAULORFLOWER.get(), new Item.Properties().useItemDescriptionPrefix()));
    ...
    protected static @NotNull ResourceKey<Item> getItemResourceKey(String name) {
        return ResourceKey.create(Registries.ITEM, MoreSnifferFlowers.loc(name));
    }
}
...
public class ModItems {
    ...
    public static final DeferredItem<Item> AROMA_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("aroma_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    public static final DeferredItem<Item> CARNAGE_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("carnage_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    ...
    public static final DeferredItem<Item> TATER_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("tater_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    public static final DeferredItem<Item> CAROTENE_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("carotene_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    public static final DeferredItem<Item> BEAT_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("beat_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    public static final DeferredItem<Item> NETHER_WART_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("nether_wart_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));
    public static final DeferredItem<Item> GRAIN_ARMOR_TRIM_SMITHING_TEMPLATE = ITEMS.register("grain_armor_trim_smithing_template", (registryName) ->SmithingTemplateItem.createArmorTrimTemplate(new Item.Properties().setId(getItemResourceKey(registryName))));

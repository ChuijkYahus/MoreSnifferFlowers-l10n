...
public class ModItems {
    ...
    public static final DeferredItem<Item> CROPRESSED_NETHERWART = ITEMS.register("cropressed_nether_wart", () -> new ItemNameBlockItem(ModBlocks.CROPRESSED_NETHERWART.get() ,new Item.Properties()));

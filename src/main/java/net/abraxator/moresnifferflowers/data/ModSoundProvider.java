...
public class ModSoundProvider extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        add(ModSoundEvents.CROPRESSOR_BELT, definition()
                .subtitle("sound.moresnifferflowers." + ModSoundEvents.CROPRESSOR_BELT.get().location().getPath())
        ...
        add(ModSoundEvents.DYESPRIA_PAINT, definition()
                .subtitle("sound.moresnifferflowers." + ModSoundEvents.DYESPRIA_PAINT.get().location().getPath())

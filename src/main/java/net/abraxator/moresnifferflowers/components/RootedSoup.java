...
public record RootedSoup(int food, float saturation, int maxUses) {
    ...
    public static final StreamCodec<RootedSoup> STREAM_CODEC = StreamCodec.composite(
            StreamCodec.INT, RootedSoup::food,
            StreamCodec.FLOAT, RootedSoup::saturation,
            StreamCodec.INT, RootedSoup::maxUses,
            RootedSoup::new
    );

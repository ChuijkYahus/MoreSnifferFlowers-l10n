...
public class DessertSnifferTemple extends Structure {
    public static final MapCodec<DessertSnifferTemple> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(DessertSnifferTemple.settingsCodec(instance),
            ...
            ).apply(instance, DessertSnifferTemple::new));
    ...
    public DessertSnifferTemple(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!DessertSnifferTemple.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructureTypes.DESSERT_SNIFFER_TEMPLE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}